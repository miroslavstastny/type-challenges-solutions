...
type GreaterThan<T extends number, U extends number, Stack extends any[] = []> =
    Stack["length"] extends T
        ? false
        : Stack["length"] extends U
            ? true
            : GreaterThan<T, U, [...Stack, T]>

type Debug = GreaterThan<4, 5>
