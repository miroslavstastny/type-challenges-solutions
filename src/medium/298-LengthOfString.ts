...
type LengthOfString<S extends string, A extends string[] = []> = S extends `${infer Head}${infer Tail}`
    ? LengthOfString<Tail,  [...A, Head]>
    : A["length"]

type Debug = ['a', 'b']["length"]
type Debug2 = LengthOfString<'reina'>
