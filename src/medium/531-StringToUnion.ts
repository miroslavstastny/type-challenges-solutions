...
type StringToUnion<T extends string, C extends string[] = []> = T extends `${infer Head}${infer Tail}` ? StringToUnion<Tail, [...C, Head]> : C[number]

type Debug = ['h', 'e', 'l', 'l', 'o'][number]
type Debug2 = StringToUnion<'hello'>
