...
type StringPermutations<S extends string, A extends string = S> = S extends any
    ? S | `${S}${StringPermutations<Exclude<A, S>>}`
    : never
...
type AllCombinations<S extends string> = StringPermutations<StringToUnion<S>>

type Debug = AllCombinations<'ABC'>
type Debug2 = StringToUnion<'ABCD'>
type Debug3 = StringPermutations<'A' | 'B'>
type Debug4 = Exclude<'A' | 'B', 'A'>
